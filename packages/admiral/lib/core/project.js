...
function buildPaths(root) {
  return {
    ...
    contextDir: path.join(root, ".admiral", "context"),
    contextProject: path.join(root, ".admiral", "context", "project.json"),
    contextTasksDir: path.join(root, ".admiral", "context", "tasks"),
    contextHandoffsDir: path.join(root, ".admiral", "context", "handoffs"),
